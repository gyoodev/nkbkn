...
<head>
  ...
  <style>
    ...
    .header { background-color: #042f2e; color: #ffffff; padding: 20px; text-align: center; }
    .header img { max-width: 150px; margin-bottom: 10px; }
    .header h1 { margin: 0; font-size: 24px; color: #ffffff !important; }
    .content { padding: 30px; line-height: 1.6; }
    .content h2 { color: #042f2e; font-size: 20px; }
    .content p { margin: 0 0 15px; }
    .footer { background-color: #f9fafb; padding: 20px; text-align: center; font-size: 12px; color: #6b7280; border-top: 1px solid #e5e7eb; }
    .footer a { color: #042f2e; text-decoration: none; }
  </style>
</head>
<body>
  <div class="container">
