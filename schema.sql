...
-- Enable Row Level Security for jockeys
ALTER TABLE public.jockeys ENABLE ROW LEVEL SECURITY;

-- Create a policy to allow public read access to jockeys
CREATE POLICY "Allow public read access" ON public.jockeys FOR SELECT USING (true);
...
-- Enable Row Level Security for trainers
ALTER TABLE public.trainers ENABLE ROW LEVEL SECURITY;

-- Create a policy to allow public read access to trainers
...
-- Enable Row Level Security for horses
ALTER TABLE public.horses ENABLE ROW LEVEL SECURITY;

-- Create a policy to allow public read access to horses
...
-- Enable Row Level Security for news_posts
ALTER TABLE public.news_posts ENABLE ROW LEVEL SECURITY;

-- Create a policy to allow public read access to news_posts
CREATE POLICY "Allow public read access" ON public.news_posts FOR SELECT USING (true);


-- Insert sample data

INSERT INTO public.jockeys (name, stats, image_url) VALUES
...
INSERT INTO public.trainers (name, achievements, associated_horses, image_url) VALUES
...
INSERT INTO public.horses (name, sire, dam, age, owner, past_results) VALUES
...
INSERT INTO public.news_posts (title, date, category, excerpt, content, image_url, href, views, likes, comments_count) VALUES
